...
const HowWeWork = () => {
  const steps = [

   {
    ...
    },
    {
      ...
      description: "We don't just provide insights. We deliver specific, prioritized steps company leaders can take to improve workplace well-being right now.",
  ...
  return (
    <section id="how-we-work" className="py-24" style={{ backgroundColor: "#ffffffff" }}>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {steps.map((step, index) => (
              <Card
                key={step.title}
                className="p-8 hover:shadow-2xl transition-all duration-500 border-2 hover:border-primary/30 group animate-fade-in-up"
