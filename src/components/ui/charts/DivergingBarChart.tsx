  ...
  return (
    <div className="space-y-4">
          ...
          <div key={i} className="space-y-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1 flex justify-end">
                ...
                >
                  {item.easier > 0 && (
                    <span className="text-xs font-bold text-white font-number" style={{ fontFamily: 'Arial, sans-serif' }}>
                      {item.easier}
                    </span>
                  )}
                </motion.div>
      ...
      <div className="flex justify-center gap-6 pt-4 border-t border-border">
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded" style={{ backgroundColor: 'hsl(251 51% 37%)' }} />
          <span className="text-sm font-semibold text-foreground">Easier</span>
        </div>
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded" style={{ backgroundColor: 'hsl(343 85% 51%)' }} />
